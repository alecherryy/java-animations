...
/**
 * This class represents an Oval. It extends the AbstractShape class, and
 * defines methods specific to ovals. A circle is also an oval, whose "height" and
 * "width" are equal.
 */
public class Oval extends AbstractShape {

  /**
   * Constructs an Oval object, with its given name, appear time, disappear time,
   * width, height, color, and position. Calls the AbstractShape super-constructor
   * and sets the ShapeType to OVAL.
   *
